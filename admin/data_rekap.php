      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <a href="../super_admin/cetak_rekap_xl.php" class='btn btn-success'>Cetak Excel</a>
            <a href="../super_admin/cetak_rekap_pdf.php" class="btn btn-danger">Cetak PDF</a><br><br>
              <?php
      include '../konek.php';
      include '../koneksi.php';
...
echo '<table border=1 id="example1" class="table table-bordered table-striped" >
		<thead>
			<tr align=center>
