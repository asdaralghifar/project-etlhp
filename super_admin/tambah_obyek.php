...
<body>
    ...
    <form action="proses-obyek.php" method="POST" enctype="multipart/form-data">
        <fieldset>
        <p>
            <label for="obyek">Obyek: </label><br>
            <input type="text" name="obyek" placeholder="obyek" required/>
        </p>
        <p>
            <label for="nolhp">No LHP: </label><br>
            <input type="text" name="nolhp" placeholder="No LHP" required/>
        </p>
        <table>
      <tr>
        <td><a href="tambah_obyek.php" class="btn btn-danger btn-block">Reset</button></td>
