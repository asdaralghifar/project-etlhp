...
<body>
    ...
    <form action="proses-tambah.php" method="POST" enctype="multipart/form-data">
        ...
        <p>
            <label for="nolhp">Nomor LHP: </label><br>
            <input type="text" name="nolhp" placeholder="Nomor LHP" required/>
        </p>
        <p>
            <label for="nolhp">Nama OPD: </label><br>
            <input type="text" name="namaopd" placeholder="Nama OPD" required/>
        </p>
        <p>
      ...
      <table>
      <tr>
        <td><a href="tambah_arsip.php" class="btn btn-danger btn-block">Reset</button></td>
