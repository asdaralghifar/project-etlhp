      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
            <a href="tambah_user.php" class="btn btn-success">Tambah Data Baru</a><br><br>
            <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    ...
                    if (isset($_GET['username']) == 'username') {
                        $sql = "DELETE FROM `table_admin` WHERE `username`='$_GET[username]'";
                        mysqli_query($con, $sql);
                    }
                    $sql = "SELECT * FROM table_admin ORDER BY username";
                    $query = mysqli_query($con, $sql);
                    $no=1;


                    if (isset($_GET['cari'])) {
                      $sql = "SELECT * FROM table_admin WHERE username LIKE '%".$_GET['cari']."%'";
                      $query = mysqli_query($con, $sql);
                    }
                    ...
                    while($siswa = mysqli_fetch_array($query)){
                      ...
                      echo "<td><a href='daftar_user.php?username=".$siswa['username']."'class='btn btn-danger' onclick=\"return confirm('Apakah anda yakin ingin menghapus data ini?') \">Delete</a></td>";
                    }
                ?>
