...
<head>
  ...
  <title>e-TLHP | Data Temuan</title>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
            <a href="tambah_temuan.php?" class="btn btn-primary">Tambah Data Baru</a>
            <a href="cetak_tm_xl.php" class="btn btn-success">Cetak Excel</a>
            <a href="cetak_temuan.php" class='btn btn-danger'>Cetak PDF</a><br><br>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
                    ...
                    while($siswa = mysqli_fetch_array($query)){
                      ...
                      echo "<td>".$siswa['obyek']."</td>";
                      echo "<td>".$siswa['nolhp']."</td>";
                      echo "<td>".$siswa['tahun_periksa']."</td>";
                      echo "<td>".$siswa['tgl']."</td>";
                      echo "<td>".$siswa['temuan']."</td>";
                      echo "<td>".$siswa['n_temuan']."</td>";
                      echo "<td>".$siswa['kd_temuan']."</td>";
                      echo "<td>".$siswa['rekom']."</td>";
                      echo "<td>".$siswa['n_temuan']."</td>";
                      echo "<td>".$siswa['kd_rekom']."</td>";
                      echo "<td>".$siswa['tl']."</td>";
                      echo "<td>".$siswa['n_temuan']."</td>";
                      echo "<td>".$siswa['kd_tl']."</td>";
                      echo "<td>".$siswa['keterangan']."</td>";
                      echo "<td>".$siswa['paraf']."</td>";
                      ?>
                      
                      <td><a href="update_temuan.php?id=<?php echo htmlspecialchars($siswa['id']); ?>" class='btn btn-success' role="button">Update</a>
                      <br><br>
                      <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id=<?php echo $siswa['id']; ?>" class='btn btn-danger' role="button" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">Delete</a></td>
                      <?php
                    }
               ?>
              </tbody>
